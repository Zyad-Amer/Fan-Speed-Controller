 ...
 *                                Definitions                                  *
 *******************************************************************************/
#define DC_motor_IN_PORT        PORTB    /*Register name*/
#define DC_motor_IN_PORT_ID     PORTB_ID /* id of the port */
#define DC_motor_IN1_PIN_ID     PIN0_ID  /* id of the pin*/
#define DC_motor_IN2_PIN_ID     PIN1_ID  /* id of the pin*/
